        ...
        if (user) {
            ...
            fetchInvestorData()
                ...
                .catch(error => {
                    ...
                    // إظهار خطأ
                    showToast('خطأ', 'تعذر جلب بيانات المستثمر', 'error');
                    
                    // إظهار شاشة الربط بمعرف المستثمر
...
function setupUIInteractions() {
    ...
    document.getElementById('quick-withdraw').addEventListener('click', () => navigateToPage('withdraw'));
    document.getElementById('view-profits').addEventListener('click', () => navigateToPage('profits'));
    document.getElementById('view-history').addEventListener('click', () => navigateToPage('transactions'));
